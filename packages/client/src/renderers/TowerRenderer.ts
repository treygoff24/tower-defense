...
import { spawnDustPuff, spawnFloatingText, spawnMuzzleFlash, spawnImpact } from './VFXHelpers';
...
export class TowerRenderer {
  ...
  handleTowerSoldVisual(data: { instanceId: string; goldRefund: number }): void {
    ...
    // Remove from tracking BEFORE the tween so update() cannot double-destroy
