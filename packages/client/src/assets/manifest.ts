...
export const ASSET_MANIFEST: AssetEntry[] = [
  ...
  { kind: 'image', key: 'ui_banner_slots', path: 'assets/Tiny Swords (Free Pack)/UI Elements/UI Banners from the store page/Banner/Slots.png' },
  { kind: 'image', key: 'ui_wood_table', path: 'assets/Tiny Swords (Free Pack)/UI Elements/UI Elements/Wood Table/WoodTable.png' },
  { kind: 'image', key: 'ui_ribbon_big',   path: 'assets/Tiny Swords (Free Pack)/UI Elements/UI Elements/Ribbons/BigRibbons.png' },
  { kind: 'image', key: 'ui_ribbon_small', path: 'assets/Tiny Swords (Free Pack)/UI Elements/UI Elements/Ribbons/SmallRibbons.png' },
  { kind: 'image', key: 'ui_paper_regular', path: 'assets/Tiny Swords (Free Pack)/UI Elements/UI Elements/Papers/RegularPaper.png' },
  { kind: 'image', key: 'ui_paper_special', path: 'assets/Tiny Swords (Free Pack)/UI Elements/UI Elements/Papers/SpecialPaper.png' },
